...
'''
# NOTE: split from script/moke_rig.py — this file keeps only the old point-scan (MFLI lock-in)
# rig. The wide-field camera rig (moke_camera_rig) moved to moke/rig.py.
#%% import
import os
import sys
import numpy as np
